...
public class EntityStateLoggerImpl implements EntityStateLogger {
    ...
    Set<EntityIdentifier> newEntries = new HashSet<>();
    Set<EntityIdentifier> removedEntries = new HashSet<>();

    private Map<EntityIdentifier, Map<String, AuditData>> previousState = new HashMap<>();
    private Map<EntityIdentifier, Map<String, AuditData>> currentState = new HashMap<>();
